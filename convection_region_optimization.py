...
if not os.path.exists("./results/"):
    os.makedirs("./results/")
torch.save(
    model.state_dict(), f"./results/convection_{args.model}_{args.seed}_region.pt"
)
...
plt.axis("off")
plt.savefig(
    f"./results/convection_{args.model}_{args.seed}_region_optimization_pred.pdf",
    bbox_inches="tight",
)
...
plt.axis("off")
plt.savefig(
    f"./results/convection_{args.model}_{args.seed}_region_optimization_error.pdf",
    bbox_inches="tight",
)
